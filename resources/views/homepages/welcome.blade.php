...
<div class="hero">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-5">
					<div class="slides">
						<img src="{{ asset('assets/frontend/images/hero-slider-1.jpg') }}" alt="Image" class="img-fluid active">
		...
		<div class="container">
			...
			<div class="row align-items-stretch">
				<div class="col-lg-4 order-lg-1">
					<div class="h-100"><div class="frame h-100"><div class="feature-img-bg h-100" style="background-image: url('{{ asset('assets/frontend/images/hero-slider-1.jpg') }}');"></div></div></div>
				</div>
